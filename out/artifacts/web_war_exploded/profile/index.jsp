...
<div class="container-fluid">
      <div style="float: left">
        <ul>
            <li><a href="#" class="active">Issued Books </a></li>
        ...
        <div class="row">
            <%
                try{
                    ...
                    ResultSet rs = stmt.executeQuery("SELECT * from records INNER JOIN books on records.ISBN=books.ISBN WHERE records.Email = '"+email+"' AND records.ReturnDate='NA'");
                    while (rs.next()){
